...
* **Clause 1.3 (Critical Freeze Action)**: Transactions exceeding $1,000 (or INR 50,000) with a Device Trust Score below 0.20 originating from high-risk merchant categories (crypto exchanges, gift card aggregators, wire remittors) must be temporarily held pending verbal human confirmation.
